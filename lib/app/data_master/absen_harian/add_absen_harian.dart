...
class AddAbsensiHarian extends StatefulWidget {
  final String lokasi;
  AddAbsensiHarian({this.lokasi});
  @override
  _AddAbsensiHarianState createState() => _AddAbsensiHarianState();
}

class _AddAbsensiHarianState extends State<AddAbsensiHarian> {
  bool trial = true;
            ...
            : Container(
                ...
                child: Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(suffixText: 'Jam'),
                      onChanged: (String str) {
                        if (str != '') {
                          controllerNama = TextEditingController(text: str);
                          if (double.parse(str) > 5) {
                            print('$str lebih dari 5');
                            controllerNama = TextEditingController(text: '5');
                            setState(() {});
                          }
                        }
                      },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: new AppBar(
        title: new Text('Tambah Absensi Harian'),
      ),
                    ...
                    if (!snapshot.hasData) {
                      ...
                      if (snapshot.data.docs.length == 0) {
                        ...
                        snapshot.data.docs.forEach((element) {
                          if (element.data().toString().contains(_lokasi)) {
                            query.add(element);
                          }
                        });
